...
CREATE  TABLE IF NOT EXISTS `PREFIX_mbatoh_block` (
  ...
  `mbatoh_block_hook` ENUM('attributeForm', 'attributeGroupForm', 'backOfficeFooter', 'backOfficeHeader', 'backOfficeHome',
        ...
        'featureForm', 'featureValueForm', 'footer', 'header', 'home', 'invoice', 'leftColumn', 'myAccountBlock', 'orderConfirmation',
