...
<div id="featured-products_block_center" class="block products_block">
	<h4>{l s='New products' od='homenewproducts'}<span class="see_all"><a href="{$link->getPageLink('new-products.php')}" title="{l s='See all' od='homenewproducts'}">{l s='See all' od='homenewproducts'}</a></span></h4>
