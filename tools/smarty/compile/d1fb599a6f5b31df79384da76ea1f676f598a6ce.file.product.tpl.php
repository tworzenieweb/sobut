...
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1fb599a6f5b31df79384da76ea1f676f598a6ce' => 
    array (
      0 => '/home/tworzenieweb/www/goldenbody/themes/presta103/product.tpl',
      1 => 1358980903,
      2 => 'file',
    ),
  ),
...
<?php }else{ ?>0<?php }?>;
var reduction_price = <?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='amount'){?><?php echo $_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'];?>
<?php }else{ ?>0<?php }?>;
...
-default-large.jpg" id="bigpic" alt="" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cover']->value['legend'], 'htmlall', 'UTF-8');?>
...
" width="20" height="20" /><?php }?></a></li>
		...
		<!-- add to cart form-->
		<form id="buy_block" <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&!isset($_smarty_tpl->tpl_vars['groups']->value)&&$_smarty_tpl->tpl_vars['product']->value->quantity>0){?>class="hidden"<?php }?> action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart.php');?>
" method="post">
...
"><?php echo smartyTranslate(array('s'=>'View'),$_smarty_tpl);?>
								...
								<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
									<a class="exclusive button ajax_add_to_cart_button" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart.php');?>
