...
<form action="{$this_path_ssl}validation.php" method="post">
	...
	<p class="cart_navigation">
		<a href="{$link->getPageLink('order.php', true)}?step=3" class="button_large button">{l s='Other payment methods' mod='cashondelivery'}</a>
		<input type="submit" name="submit" value="{l s='I confirm my order' mod='cashondelivery'}" class="exclusive_large button" />
	</p>
</form>
        <div class="clear"></div>
</div>
